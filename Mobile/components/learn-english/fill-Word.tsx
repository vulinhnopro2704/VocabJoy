...
const SoundFillWord: React.FC<{ vocab: Vocab; setTextParent: any }> = ({
	vocab,
	setTextParent,
}) => {
		...
		<View style={styles.container}>
			<View style={styles.sounds}>
				<TouchableOpacity onPress={() => playSound(1)}>
					<View style={styles.button_el}>
						<AntDesign name="sound" size={24} color={Colors.blue} />
					</View>
				</TouchableOpacity>
				<TouchableOpacity
					onPress={() => {
			...
			<TextInput
				...
				style={[
					styles.textinput,
					{ borderColor: focus ? "green" : "Colors.gray_500" },
				]}
